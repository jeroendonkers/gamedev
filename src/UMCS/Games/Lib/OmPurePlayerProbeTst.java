...
// test the effect of beta parameter in probes

public class OmPurePlayerProbeTst extends AlphaBetaPlayer {

   public OmPurePlayerProbeTst(Game g, Evaluator op, int md) 
   { super(g,md); 
     eval = g.getDefaultEvaluator();
     evalop = op;
   }

   public OmPurePlayerProbeTst(Game g, Evaluator e, Evaluator op, int md) 
   { super(g,md); 
     eval = e; evalop = op;
   }
 ...
 // CHANGED HERE !!!!!!
         bestResult = omSearch(mm,depth-1,(short)(bestValop),pre+"  "); 
 //
