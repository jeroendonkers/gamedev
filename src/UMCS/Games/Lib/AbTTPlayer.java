...
public class AbTTPlayer extends Player {

   public  AbTTPlayer(Game g, int md) 
   { super(g); 
   ...
   public  AbTTPlayer(Game g, Evaluator e, int md) 
   { super(g); 
     eval = e;
     hhtable = getGame().getNewHHTable();
     maxDepth = md;
   ...
   public String getName() { return "AlphaBeta Player TT"; }
