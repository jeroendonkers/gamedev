...
public class OmTTdPlayer extends AbTTPlayer {

   public OmTTdPlayer(Game g, Evaluator op, int md, int sd) 
   { this(g,op,g.getDefaultEvaluator(),md,sd); 
   }

   public OmTTdPlayer(Game g, Evaluator e, Evaluator op, int md, int sd) 
   { super(g,op,md); 
   ...
   private SearchResult omSearch(Node m, int depth, short beta, String pre) 
    throws OutOfTimeException {
      ...
      if (depth<=searchDepth-specDepth) {
          ...
          SearchResult r = omprobeplayer.alphabeta(m,depth,(short)(globalpha-1),POSINF,pre);  // AB - OM PROBE
